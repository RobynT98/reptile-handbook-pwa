  ...
  <div className="space-y-4">
    <Card title="Formulär &amp; Verktyg">
      ...
      <p className="mt-1 text-xs text-slate-400">
        Vill du senare dela med världen kan du exportera datan manuellt och
        lägga in i repo – men det är helt frivilligt.
      </p>
      <p className="mt-2 text-xs text-slate-400">
        Lokalt sparade artprofiler just nu:{' '}
        <span className="font-semibold text-emerald-400">{localCount}</span>
      </p>
      ...
      {localCount > 0 && (
        <button
          ...
          className="mt-3 rounded border border-red-700 bg-red-900/30 px-2 py-1 text-[0.7rem] text-red-200 hover:bg-red-900/60"
        >
